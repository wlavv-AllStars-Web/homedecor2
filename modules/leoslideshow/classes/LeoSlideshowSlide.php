...
//        }
    ...
    {
        $params_data = array_merge($pattern, json_decode(LeoSlideshowSlide::base64Decode($this->params), true));
    ...
    public function debug()
    {
        ...
        foreach ($this->layersparams as $key => $value) {
            ...
            $this->layersparams_debug['lang_id_' . $key . '_' . $lang_iso] = json_decode(LeoSlideshowSlide::base64Decode($value), true);
        }
        ...
        foreach ($this->params as $key => $value) {
            ...
            $this->params_debug['lang_id_' . $key . '_' . $lang_iso] = json_decode(LeoSlideshowSlide::base64Decode($value), true);
        }
        unset($this->params);
        ...
        foreach ($this->params as $key => $value) {
            ...
            $this->video_debug['lang_id_' . $key . '_' . $lang_iso] = json_decode(LeoSlideshowSlide::base64Decode($value), true);
        }
        unset($this->video);
        unset($this->def);
